      ...
      <div className="flex flex-1 gap-4 lg:gap-6 overflow-hidden lg:flex-row flex-col">
        ...
        {selectedConversacion ? (
          <div className="flex-1 w-full lg:w-auto bg-white rounded-lg shadow overflow-hidden flex flex-col lg:h-auto h-screen lg:max-h-full">
            {/* Header Chat */}
            <div className="bg-gradient-to-r from-[#182442] to-[#006c49] text-white px-2 py-1 lg:p-4 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-1 lg:gap-3 flex-shrink-0">
              <div>
              ...
              <div className="flex gap-1 lg:gap-2">
                <button
                  ...
                  className="p-1 bg-white/20 hover:bg-white/30 rounded text-lg"
                  title="Reasignar"
                >
                  👤
                </button>
                ...
                <button
                  ...
                  className="lg:hidden p-1 bg-white/20 hover:bg-white/30 rounded text-sm"
                  title="Volver"
                >
                  ← Atrás
                </button>
